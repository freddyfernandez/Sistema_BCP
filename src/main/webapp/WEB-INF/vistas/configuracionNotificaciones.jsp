 ...
 <h1>Configuracion De Notificaciones</h1>
		 <div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCrudModalidad">
		       ...
		       <form accept-charset="UTF-8"  action="consultaConfiguracionNotificaciones" class="simple_form" id="defaultForm2"  method="post">
								...
								<div class="content" >
									...
									<table id="tablePaginacion" class="table table-striped table-bordered" >
										...
										<tbody>
												...
												<c:forEach items="${sessionScope.configuracionNotificaciones}" var="x">
													<tr>
														...
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idConfiguracionNotificacion}','${x.estado}','${x.tipoMovimiento.idTipoMovimiento}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
  	 ...
  	 <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Configuracion de Notificaciones</h4>
				</div>
		                    ...
		                    <div class="panel-group" id="steps">
		                        ...
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Configuracion de Notificaciones</a></h4>
		                            </div>
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_reg_tipom"  name="tipoMovimiento.idTipoMovimiento" type="text" />
		                                        </div>
		                                     </div>
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="actualizaConfiguracionNotificacion" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idConfiguracionNotificacion" type="text" />
		                                        </div>
		                                     </div>
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_ID">TIPO</label>
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_tipom" readonly="readonly" name="tipoMovimiento.idTipoMovimiento" type="text" />
		                                        </div>
		                                     </div>
